...
mainBody = 
    ...
    . showString "  parse cmdLineArgs\n"
    . showString "  migrator_run_migrations\n"

mainImports :: String -> String
mainImports =
    showString "import System.Environment (getArgs)\n"
  . showString "import Migrator.Discover.Parse (parse)\n"